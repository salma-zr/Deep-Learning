...
for exp in cb_ollama_llama3_8b cb_openai_mini cb_openrouter_free \
  prompt_one_sentence_post prompt_one_sentence_nopost prompt_flashcard prompt_uncertainty \
  ft_1k ft_5k ft_20k rag_wiki_k3 rag_wiki_k5
do
